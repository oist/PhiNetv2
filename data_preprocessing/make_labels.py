...
parser.add_argument('--datadir', type=str, default='../datasets/k400/videos')
parser.add_argument('--filedir', type=str, default='../datasets/k400/videos/train2')
...
with open('../datasets/labels/label_1.0.pickle', 'wb') as f:
