...
def get_args_parser():
    ...
    parser.add_argument('--davis_path', default='datasets/davis-2017/DAVIS_480_880', type=str, help='Path to the JHMDB dataset')
    ...
    parser.add_argument('--backbone', default='vit_small', type=str, choices=['vit_small', 'vit_large'], help='Size of the model')
    parser.add_argument('--patch_size', default=16, type=int, help='Patch size of the model')

    # JHMDB-related evaluation arguments
    parser.add_argument('--jhmdb_temperature', default=0.1, type=float, help='Temperature for the label propagation')
    parser.add_argument('--jhmdb_topk', default=10, type=int, help='Number of top-k predictions to consider')
    parser.add_argument('--jhmdb_radius', default=5, type=int, help='Radius for the label propagation')
    parser.add_argument('--jhmdb_video_len', default=30, type=int, help='Length of the video')
    ...
    parser.add_argument('--vip_temperature', default=0.1, type=float, help='Temperature for the label propagation')
    parser.add_argument('--vip_topk', default=7, type=int, help='Number of top-k predictions to consider')
    parser.add_argument('--vip_radius', default=5, type=int, help='Radius for the label propagation')
    parser.add_argument('--vip_video_len', default=3, type=int, help='Length of the video')
