...
import sys
sys.path.append("eval/util_eval")
sys.path.append("eval/")
sys.path.append("eval/*")
from util_eval import get_args_parser as get_prop_args_parser
...
def _label_propagation(args):
    ...
    needed_args = set(["model_type", "model_vit", "resume", "save_path", "temperature", "topk", "radius", "video_len", "filelist", "crop_size"])
